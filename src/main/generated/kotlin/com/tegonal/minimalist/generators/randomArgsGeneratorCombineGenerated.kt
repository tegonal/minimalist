 ...
 *
 * @return The resulting [RandomArgsGenerator] which generates values of type [Tuple2].
 *
 * @since 2.0.0
 */
...
): RandomArgsGenerator<Tuple2<A1, A2>> = this.combine(other, ::Tuple2)
 ...
 *
 * @return The resulting [RandomArgsGenerator] which generates values of type [Tuple3].
 *
 * @since 2.0.0
 */
@JvmName("combineToTuple3")
fun <A1, A2, A3> RandomArgsGenerator<Tuple2<A1, A2>>.combine(
	other: RandomArgsGenerator<A3>
): RandomArgsGenerator<Tuple3<A1, A2, A3>> = this.combine(other) { args, otherArg ->
...
fun <A1, A2, A3, A4> RandomArgsGenerator<Tuple3<A1, A2, A3>>.combine(
