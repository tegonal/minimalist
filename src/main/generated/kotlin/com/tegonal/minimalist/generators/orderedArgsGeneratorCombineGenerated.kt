 ...
 *
 * @return The resulting [OrderedArgsGenerator] which generates values of type [Pair].
 *
 * @since 2.0.0
 */
 ...
 * resulting in a [OrderedArgsGenerator] which generates [Pair].
 *
...
>.combineAll(): OrderedArgsGenerator<Pair<A1, A2>> =
 ...
 *
 * @return The resulting [OrderedArgsGenerator] which generates values of type [Triple].
 *
 * @since 2.0.0
 */
...
): OrderedArgsGenerator<Triple<A1, A2, A3>> = this.combine(other) { args, otherArg ->
	args.append(otherArg)
}

/**
 * Combines the [component1] [OrderedArgsGenerator] with all other [OrderedArgsGenerator] from left to right
 * resulting in a [OrderedArgsGenerator] which generates [Triple].
 *
 * The resulting [OrderedArgsGenerator] generates the product of all [OrderedArgsGenerator.size] values before repeating.
 *
...
>.combineAll(): OrderedArgsGenerator<Triple<A1, A2, A3>> =
...
fun <A1, A2, A3, A4> OrderedArgsGenerator<Triple<A1, A2, A3>>.combine(
