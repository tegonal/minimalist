...
public class Args9AppendTest {
	...
	public void append_Args1() {
		...
		expect(argsResult, e -> {
			...
			toEqual(getA9(e), firstArgs.getA9());
			...
			toEqual(getRepresentation9(e), firstArgs.getRepresentation9());
			toEqual(getA10(e), secondArgs.getA1());
			toEqual(getRepresentation10(e), secondArgs.getRepresentation1());
