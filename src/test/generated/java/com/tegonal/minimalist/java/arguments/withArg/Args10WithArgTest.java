...
// --------------------------------------------------------------------------------------------------------------------
package com.tegonal.variist.java.arguments.withArg;
...
public class Args10WithArgTest {
	...
	public void withArg1() {
		...
		expect(args, e -> {
			...
			toEqual(getRepresentation10(e), "rep 10");
		...
		expect(argsResult, e -> {
			...
			toEqual(getRepresentation10(e), args.getRepresentation10());
			return Unit.INSTANCE;
		});
	}
	...
	public void withArg9() {
		...
		var argsResult = args.withArg9((byte) 3, "new rep");
		...
		expect(argsResult, e -> {
			...
			toEqual(getRepresentation7(e), args.getRepresentation7());
			toEqual(getRepresentation8(e), args.getRepresentation8());
			toEqual(getRepresentation9(e), "new rep");
			toEqual(getRepresentation10(e), args.getRepresentation10());
			return Unit.INSTANCE;
		});
	}
	...
	public void withArg10() {
		...
		var argsResult = args.withArg10(BigInteger.valueOf(4), "new rep");
		...
		expect(argsResult, e -> {
			...
			toEqual(getA8(e), args.getA8());
			toEqual(getA9(e), args.getA9());
			toEqual(getA10(e), BigInteger.valueOf(4));
			toEqual(getRepresentation1(e), args.getRepresentation1());
			toEqual(getRepresentation2(e), args.getRepresentation2());
			toEqual(getRepresentation3(e), args.getRepresentation3());
			toEqual(getRepresentation4(e), args.getRepresentation4());
			...
			toEqual(getRepresentation8(e), args.getRepresentation8());
			toEqual(getRepresentation9(e), args.getRepresentation9());
			toEqual(getRepresentation10(e), "new rep");
			return Unit.INSTANCE;
		});
	}
