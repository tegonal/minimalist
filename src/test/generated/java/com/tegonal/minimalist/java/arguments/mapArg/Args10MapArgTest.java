...
public class Args10MapArgTest {
	...
	public void mapArg10() {
		...
		var argsResult = args.mapArg10(it -> it.get(0));
		...
		expect(argsResult, e -> {
			...
			toEqual(getRepresentation8(e), args.getRepresentation8());
			toEqual(getRepresentation9(e), args.getRepresentation9());
			toEqual(getRepresentation10(e), null);
				return Unit.INSTANCE;
		});
	}

	@Test
	public void mapArg10WithRepresentation() {
		var args = Args.of(
			List.of(1),
			List.of(2L),
			List.of(3F),
		...
		var argsResult = args.mapArg10WithRepresentation((arg, repr) -> new Pair<>(arg.get(0), repr + " modified"));
		...
		expect(argsResult, e -> {
			...
			toEqual(getRepresentation8(e), args.getRepresentation8());
			toEqual(getRepresentation9(e), args.getRepresentation9());
			toEqual(getRepresentation10(e), "rep 10 modified");
				return Unit.INSTANCE;
		});
	}
