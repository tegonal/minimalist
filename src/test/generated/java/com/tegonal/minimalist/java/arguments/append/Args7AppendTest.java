...
public class Args7AppendTest {
	...
	public void append_Args1() {
		...
		expect(argsResult, e -> {
			...
			toEqual(getA8(e), secondArgs.getA1());
			toEqual(getRepresentation8(e), secondArgs.getRepresentation1());
	...
	public void append_Args2() {
		...
		expect(argsResult, e -> {
			...
			toEqual(getRepresentation7(e), firstArgs.getRepresentation7());
			toEqual(getA8(e), secondArgs.getA1());
			toEqual(getA9(e), secondArgs.getA2());
			toEqual(getRepresentation8(e), secondArgs.getRepresentation1());
			toEqual(getRepresentation9(e), secondArgs.getRepresentation2());
			return Unit.INSTANCE;
		});
	}
	...
	public void append_Args3() {
		...
		expect(argsResult, e -> {
			...
			toEqual(getA8(e), secondArgs.getA1());
			toEqual(getA9(e), secondArgs.getA2());
			toEqual(getA10(e), secondArgs.getA3());
			toEqual(getRepresentation8(e), secondArgs.getRepresentation1());
			toEqual(getRepresentation9(e), secondArgs.getRepresentation2());
			toEqual(getRepresentation10(e), secondArgs.getRepresentation3());
			return Unit.INSTANCE;
		});
	}
