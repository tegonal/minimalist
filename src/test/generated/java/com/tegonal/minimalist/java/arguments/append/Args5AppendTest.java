...
public class Args5AppendTest {
	...
	public void append_Args1() {
		...
		expect(argsResult, e -> {
			...
			toEqual(getA6(e), secondArgs.getA1());
			toEqual(getRepresentation6(e), secondArgs.getRepresentation1());
	...
	public void append_Args2() {
		...
		expect(argsResult, e -> {
			...
			toEqual(getRepresentation5(e), firstArgs.getRepresentation5());
			toEqual(getA6(e), secondArgs.getA1());
			toEqual(getA7(e), secondArgs.getA2());
			toEqual(getRepresentation6(e), secondArgs.getRepresentation1());
			toEqual(getRepresentation7(e), secondArgs.getRepresentation2());
			return Unit.INSTANCE;
		});
	}
	...
	public void append_Args3() {
		...
		expect(argsResult, e -> {
			...
			toEqual(getA6(e), secondArgs.getA1());
			toEqual(getA7(e), secondArgs.getA2());
			toEqual(getA8(e), secondArgs.getA3());
			toEqual(getRepresentation6(e), secondArgs.getRepresentation1());
			toEqual(getRepresentation7(e), secondArgs.getRepresentation2());
			toEqual(getRepresentation8(e), secondArgs.getRepresentation3());
			return Unit.INSTANCE;
		});
	}
	...
	public void append_Args4() {
		...
		expect(argsResult, e -> {
			...
			toEqual(getA7(e), secondArgs.getA2());
			toEqual(getA8(e), secondArgs.getA3());
			toEqual(getA9(e), secondArgs.getA4());
			toEqual(getRepresentation6(e), secondArgs.getRepresentation1());
			toEqual(getRepresentation7(e), secondArgs.getRepresentation2());
			toEqual(getRepresentation8(e), secondArgs.getRepresentation3());
			toEqual(getRepresentation9(e), secondArgs.getRepresentation4());
			return Unit.INSTANCE;
		});
	}
	...
	public void append_Args5() {
		...
		expect(argsResult, e -> {
			...
			toEqual(getA8(e), secondArgs.getA3());
			toEqual(getA9(e), secondArgs.getA4());
			toEqual(getA10(e), secondArgs.getA5());
			toEqual(getRepresentation6(e), secondArgs.getRepresentation1());
			toEqual(getRepresentation7(e), secondArgs.getRepresentation2());
			toEqual(getRepresentation8(e), secondArgs.getRepresentation3());
			toEqual(getRepresentation9(e), secondArgs.getRepresentation4());
			toEqual(getRepresentation10(e), secondArgs.getRepresentation5());
			return Unit.INSTANCE;
		});
	}
