...
public class Args2AppendTest {
	...
	public void append_Args1() {
		...
		expect(argsResult, e -> {
			...
			toEqual(getA3(e), secondArgs.getA1());
			toEqual(getRepresentation3(e), secondArgs.getRepresentation1());
	...
	public void append_Args2() {
		...
		expect(argsResult, e -> {
			...
			toEqual(getRepresentation2(e), firstArgs.getRepresentation2());
			toEqual(getA3(e), secondArgs.getA1());
			toEqual(getA4(e), secondArgs.getA2());
			toEqual(getRepresentation3(e), secondArgs.getRepresentation1());
			toEqual(getRepresentation4(e), secondArgs.getRepresentation2());
			return Unit.INSTANCE;
		});
	}
	...
	public void append_Args3() {
		...
		expect(argsResult, e -> {
			...
			toEqual(getA3(e), secondArgs.getA1());
			toEqual(getA4(e), secondArgs.getA2());
			toEqual(getA5(e), secondArgs.getA3());
			toEqual(getRepresentation3(e), secondArgs.getRepresentation1());
			toEqual(getRepresentation4(e), secondArgs.getRepresentation2());
			toEqual(getRepresentation5(e), secondArgs.getRepresentation3());
			return Unit.INSTANCE;
		});
	}
	...
	public void append_Args4() {
		...
		expect(argsResult, e -> {
			...
			toEqual(getA4(e), secondArgs.getA2());
			toEqual(getA5(e), secondArgs.getA3());
			toEqual(getA6(e), secondArgs.getA4());
			toEqual(getRepresentation3(e), secondArgs.getRepresentation1());
			toEqual(getRepresentation4(e), secondArgs.getRepresentation2());
			toEqual(getRepresentation5(e), secondArgs.getRepresentation3());
			toEqual(getRepresentation6(e), secondArgs.getRepresentation4());
			return Unit.INSTANCE;
		});
	}
	...
	public void append_Args5() {
		...
		expect(argsResult, e -> {
			...
			toEqual(getA5(e), secondArgs.getA3());
			toEqual(getA6(e), secondArgs.getA4());
			toEqual(getA7(e), secondArgs.getA5());
			toEqual(getRepresentation3(e), secondArgs.getRepresentation1());
			toEqual(getRepresentation4(e), secondArgs.getRepresentation2());
			toEqual(getRepresentation5(e), secondArgs.getRepresentation3());
			toEqual(getRepresentation6(e), secondArgs.getRepresentation4());
			toEqual(getRepresentation7(e), secondArgs.getRepresentation5());
			return Unit.INSTANCE;
		});
	}
	...
	public void append_Args6() {
		...
		expect(argsResult, e -> {
			...
			toEqual(getA6(e), secondArgs.getA4());
			toEqual(getA7(e), secondArgs.getA5());
			toEqual(getA8(e), secondArgs.getA6());
			toEqual(getRepresentation3(e), secondArgs.getRepresentation1());
			toEqual(getRepresentation4(e), secondArgs.getRepresentation2());
			toEqual(getRepresentation5(e), secondArgs.getRepresentation3());
			toEqual(getRepresentation6(e), secondArgs.getRepresentation4());
			toEqual(getRepresentation7(e), secondArgs.getRepresentation5());
			toEqual(getRepresentation8(e), secondArgs.getRepresentation6());
			return Unit.INSTANCE;
		});
	}
	...
	public void append_Args7() {
		...
		expect(argsResult, e -> {
			...
			toEqual(getA7(e), secondArgs.getA5());
			toEqual(getA8(e), secondArgs.getA6());
			toEqual(getA9(e), secondArgs.getA7());
			toEqual(getRepresentation3(e), secondArgs.getRepresentation1());
			toEqual(getRepresentation4(e), secondArgs.getRepresentation2());
			toEqual(getRepresentation5(e), secondArgs.getRepresentation3());
			toEqual(getRepresentation6(e), secondArgs.getRepresentation4());
			toEqual(getRepresentation7(e), secondArgs.getRepresentation5());
			toEqual(getRepresentation8(e), secondArgs.getRepresentation6());
			toEqual(getRepresentation9(e), secondArgs.getRepresentation7());
			return Unit.INSTANCE;
		});
	}
	...
	public void append_Args8() {
		...
		expect(argsResult, e -> {
			...
			toEqual(getA8(e), secondArgs.getA6());
			toEqual(getA9(e), secondArgs.getA7());
			toEqual(getA10(e), secondArgs.getA8());
			toEqual(getRepresentation3(e), secondArgs.getRepresentation1());
			toEqual(getRepresentation4(e), secondArgs.getRepresentation2());
			toEqual(getRepresentation5(e), secondArgs.getRepresentation3());
			toEqual(getRepresentation6(e), secondArgs.getRepresentation4());
			...
			toEqual(getRepresentation8(e), secondArgs.getRepresentation6());
			toEqual(getRepresentation9(e), secondArgs.getRepresentation7());
			toEqual(getRepresentation10(e), secondArgs.getRepresentation8());
			return Unit.INSTANCE;
		});
	}
