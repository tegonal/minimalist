...
public class Args8DropTest {
	...
	public void dropArg1() {
		...
		Args7<Long, Float, Double, Character, String, LocalDate, Short> argsResult = args.dropArg1();
		expect(argsResult, e -> {
	...
	public void dropArg2() {
		...
		Args7<Integer, Float, Double, Character, String, LocalDate, Short> argsResult = args.dropArg2();
		expect(argsResult, e -> {
	...
	public void dropArg3() {
		...
		Args7<Integer, Long, Double, Character, String, LocalDate, Short> argsResult = args.dropArg3();
		expect(argsResult, e -> {
			toEqual(getA1(e), args.getA1());
	...
	public void dropArg4() {
		...
		Args7<Integer, Long, Float, Character, String, LocalDate, Short> argsResult = args.dropArg4();
		expect(argsResult, e -> {
			toEqual(getA1(e), args.getA1());
			toEqual(getA2(e), args.getA2());
	...
	public void dropArg5() {
		...
		Args7<Integer, Long, Float, Double, String, LocalDate, Short> argsResult = args.dropArg5();
		expect(argsResult, e -> {
			toEqual(getA1(e), args.getA1());
			toEqual(getA2(e), args.getA2());
			toEqual(getA3(e), args.getA3());
	...
	public void dropArg6() {
		...
		Args7<Integer, Long, Float, Double, Character, LocalDate, Short> argsResult = args.dropArg6();
		expect(argsResult, e -> {
			toEqual(getA1(e), args.getA1());
			toEqual(getA2(e), args.getA2());
			toEqual(getA3(e), args.getA3());
	...
	public void dropArg7() {
		...
		Args7<Integer, Long, Float, Double, Character, String, Short> argsResult = args.dropArg7();
		expect(argsResult, e -> {
			toEqual(getA1(e), args.getA1());
			toEqual(getA2(e), args.getA2());
			toEqual(getA3(e), args.getA3());
	...
	public void dropArg8() {
		...
		Args7<Integer, Long, Float, Double, Character, String, LocalDate> argsResult = args.dropArg8();
		expect(argsResult, e -> {
			toEqual(getA1(e), args.getA1());
			toEqual(getA2(e), args.getA2());
			toEqual(getA3(e), args.getA3());
