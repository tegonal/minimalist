...
public class Args9DropTest {
	...
	public void dropArg1() {
		...
		Args8<Long, Float, Double, Character, String, LocalDate, Short, Byte> argsResult = args.dropArg1();
		expect(argsResult, e -> {
	...
	public void dropArg2() {
		...
		Args8<Integer, Float, Double, Character, String, LocalDate, Short, Byte> argsResult = args.dropArg2();
		expect(argsResult, e -> {
	...
	public void dropArg3() {
		...
		Args8<Integer, Long, Double, Character, String, LocalDate, Short, Byte> argsResult = args.dropArg3();
		expect(argsResult, e -> {
			toEqual(getA1(e), args.getA1());
	...
	public void dropArg4() {
		...
		Args8<Integer, Long, Float, Character, String, LocalDate, Short, Byte> argsResult = args.dropArg4();
		expect(argsResult, e -> {
			toEqual(getA1(e), args.getA1());
			toEqual(getA2(e), args.getA2());
	...
	public void dropArg5() {
		...
		Args8<Integer, Long, Float, Double, String, LocalDate, Short, Byte> argsResult = args.dropArg5();
		expect(argsResult, e -> {
			toEqual(getA1(e), args.getA1());
			toEqual(getA2(e), args.getA2());
			toEqual(getA3(e), args.getA3());
	...
	public void dropArg6() {
		...
		Args8<Integer, Long, Float, Double, Character, LocalDate, Short, Byte> argsResult = args.dropArg6();
		expect(argsResult, e -> {
			toEqual(getA1(e), args.getA1());
			toEqual(getA2(e), args.getA2());
			toEqual(getA3(e), args.getA3());
	...
	public void dropArg7() {
		...
		Args8<Integer, Long, Float, Double, Character, String, Short, Byte> argsResult = args.dropArg7();
		expect(argsResult, e -> {
			toEqual(getA1(e), args.getA1());
			toEqual(getA2(e), args.getA2());
			toEqual(getA3(e), args.getA3());
	...
	public void dropArg8() {
		...
		Args8<Integer, Long, Float, Double, Character, String, LocalDate, Byte> argsResult = args.dropArg8();
		expect(argsResult, e -> {
			toEqual(getA1(e), args.getA1());
			toEqual(getA2(e), args.getA2());
			toEqual(getA3(e), args.getA3());
	...
	public void dropArg9() {
		...
		Args8<Integer, Long, Float, Double, Character, String, LocalDate, Short> argsResult = args.dropArg9();
		expect(argsResult, e -> {
			toEqual(getA1(e), args.getA1());
			toEqual(getA2(e), args.getA2());
			toEqual(getA3(e), args.getA3());
