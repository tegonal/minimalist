...
public class Args6DropTest {
	...
	public void dropArg1() {
		...
		Args5<Long, Float, Double, Character, String> argsResult = args.dropArg1();
		expect(argsResult, e -> {
	...
	public void dropArg2() {
		...
		Args5<Integer, Float, Double, Character, String> argsResult = args.dropArg2();
		expect(argsResult, e -> {
	...
	public void dropArg3() {
		...
		Args5<Integer, Long, Double, Character, String> argsResult = args.dropArg3();
		expect(argsResult, e -> {
			toEqual(getA1(e), args.getA1());
	...
	public void dropArg4() {
		...
		Args5<Integer, Long, Float, Character, String> argsResult = args.dropArg4();
		expect(argsResult, e -> {
			toEqual(getA1(e), args.getA1());
			toEqual(getA2(e), args.getA2());
	...
	public void dropArg5() {
		...
		Args5<Integer, Long, Float, Double, String> argsResult = args.dropArg5();
		expect(argsResult, e -> {
			toEqual(getA1(e), args.getA1());
			toEqual(getA2(e), args.getA2());
			toEqual(getA3(e), args.getA3());
	...
	public void dropArg6() {
		...
		Args5<Integer, Long, Float, Double, Character> argsResult = args.dropArg6();
		expect(argsResult, e -> {
			toEqual(getA1(e), args.getA1());
			toEqual(getA2(e), args.getA2());
			toEqual(getA3(e), args.getA3());
