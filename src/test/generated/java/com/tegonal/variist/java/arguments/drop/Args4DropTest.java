...
public class Args4DropTest {
	...
	public void dropArg1() {
		...
		Args3<Long, Float, Double> argsResult = args.dropArg1();
		expect(argsResult, e -> {
	...
	public void dropArg2() {
		...
		Args3<Integer, Float, Double> argsResult = args.dropArg2();
		expect(argsResult, e -> {
	...
	public void dropArg3() {
		...
		Args3<Integer, Long, Double> argsResult = args.dropArg3();
		expect(argsResult, e -> {
			toEqual(getA1(e), args.getA1());
	...
	public void dropArg4() {
		...
		Args3<Integer, Long, Float> argsResult = args.dropArg4();
		expect(argsResult, e -> {
			toEqual(getA1(e), args.getA1());
			toEqual(getA2(e), args.getA2());
