...
class Args9DropTest {
	...
	fun dropArg1() {
		...
		val argsResult: Args8<Long, Float, Double, Char, String, LocalDate, Short, Byte> = args.dropArg1()
		expect(argsResult) {
			a1.toEqual(args.a2)
			a2.toEqual(args.a3)
			a3.toEqual(args.a4)
	...
	fun dropArg2() {
		...
		val argsResult: Args8<Int, Float, Double, Char, String, LocalDate, Short, Byte> = args.dropArg2()
		expect(argsResult) {
			a1.toEqual(args.a1)
			a2.toEqual(args.a3)
			a3.toEqual(args.a4)
	...
	fun dropArg3() {
		...
		val argsResult: Args8<Int, Long, Double, Char, String, LocalDate, Short, Byte> = args.dropArg3()
		expect(argsResult) {
			a1.toEqual(args.a1)
			a2.toEqual(args.a2)
			a3.toEqual(args.a4)
	...
	fun dropArg4() {
		...
		val argsResult: Args8<Int, Long, Float, Char, String, LocalDate, Short, Byte> = args.dropArg4()
		expect(argsResult) {
			a1.toEqual(args.a1)
			a2.toEqual(args.a2)
			a3.toEqual(args.a3)
	...
	fun dropArg5() {
		...
		val argsResult: Args8<Int, Long, Float, Double, String, LocalDate, Short, Byte> = args.dropArg5()
		expect(argsResult) {
			a1.toEqual(args.a1)
			a2.toEqual(args.a2)
			a3.toEqual(args.a3)
	...
	fun dropArg6() {
		...
		val argsResult: Args8<Int, Long, Float, Double, Char, LocalDate, Short, Byte> = args.dropArg6()
		expect(argsResult) {
			a1.toEqual(args.a1)
			a2.toEqual(args.a2)
			a3.toEqual(args.a3)
	...
	fun dropArg7() {
		...
		val argsResult: Args8<Int, Long, Float, Double, Char, String, Short, Byte> = args.dropArg7()
		expect(argsResult) {
			a1.toEqual(args.a1)
			a2.toEqual(args.a2)
			a3.toEqual(args.a3)
	...
	fun dropArg8() {
		...
		val argsResult: Args8<Int, Long, Float, Double, Char, String, LocalDate, Byte> = args.dropArg8()
		expect(argsResult) {
			a1.toEqual(args.a1)
			a2.toEqual(args.a2)
			a3.toEqual(args.a3)
	...
	fun dropArg9() {
		...
		val argsResult: Args8<Int, Long, Float, Double, Char, String, LocalDate, Short> = args.dropArg9()
		expect(argsResult) {
			a1.toEqual(args.a1)
			a2.toEqual(args.a2)
			a3.toEqual(args.a3)
