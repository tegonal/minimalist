...
class Args8DropTest {
	...
	fun dropArg1() {
		...
		val argsResult: Args7<Int, Long, Float, Double, Char, LocalDate, Short> = args.dropArg1()
		expect(argsResult) {
			a1.toEqual(args.a2)
			a2.toEqual(args.a3)
			a3.toEqual(args.a4)
	...
	fun dropArg2() {
		...
		val argsResult: Args7<String, Long, Float, Double, Char, LocalDate, Short> = args.dropArg2()
		expect(argsResult) {
			a1.toEqual(args.a1)
			a2.toEqual(args.a3)
			a3.toEqual(args.a4)
	...
	fun dropArg3() {
		...
		val argsResult: Args7<String, Int, Float, Double, Char, LocalDate, Short> = args.dropArg3()
		expect(argsResult) {
			a1.toEqual(args.a1)
			a2.toEqual(args.a2)
			a3.toEqual(args.a4)
	...
	fun dropArg4() {
		...
		val argsResult: Args7<String, Int, Long, Double, Char, LocalDate, Short> = args.dropArg4()
		expect(argsResult) {
			a1.toEqual(args.a1)
			a2.toEqual(args.a2)
			a3.toEqual(args.a3)
	...
	fun dropArg5() {
		...
		val argsResult: Args7<String, Int, Long, Float, Char, LocalDate, Short> = args.dropArg5()
		expect(argsResult) {
			a1.toEqual(args.a1)
			a2.toEqual(args.a2)
			a3.toEqual(args.a3)
	...
	fun dropArg6() {
		...
		val argsResult: Args7<String, Int, Long, Float, Double, LocalDate, Short> = args.dropArg6()
		expect(argsResult) {
			a1.toEqual(args.a1)
			a2.toEqual(args.a2)
			a3.toEqual(args.a3)
	...
	fun dropArg7() {
		...
		val argsResult: Args7<String, Int, Long, Float, Double, Char, Short> = args.dropArg7()
		expect(argsResult) {
			a1.toEqual(args.a1)
			a2.toEqual(args.a2)
			a3.toEqual(args.a3)
	...
	fun dropArg8() {
		...
		val argsResult: Args7<String, Int, Long, Float, Double, Char, LocalDate> = args.dropArg8()
		expect(argsResult) {
			a1.toEqual(args.a1)
			a2.toEqual(args.a2)
			a3.toEqual(args.a3)
