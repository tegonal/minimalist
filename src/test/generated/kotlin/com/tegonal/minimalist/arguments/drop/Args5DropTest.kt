...
class Args5DropTest {
	...
	fun dropArg1() {
		...
		val argsResult: Args4<Int, Long, Float, Double> = args.dropArg1()
		expect(argsResult) {
			a1.toEqual(args.a2)
			a2.toEqual(args.a3)
			a3.toEqual(args.a4)
	...
	fun dropArg2() {
		...
		val argsResult: Args4<String, Long, Float, Double> = args.dropArg2()
		expect(argsResult) {
			a1.toEqual(args.a1)
			a2.toEqual(args.a3)
			a3.toEqual(args.a4)
	...
	fun dropArg3() {
		...
		val argsResult: Args4<String, Int, Float, Double> = args.dropArg3()
		expect(argsResult) {
			a1.toEqual(args.a1)
			a2.toEqual(args.a2)
			a3.toEqual(args.a4)
	...
	fun dropArg4() {
		...
		val argsResult: Args4<String, Int, Long, Double> = args.dropArg4()
		expect(argsResult) {
			a1.toEqual(args.a1)
			a2.toEqual(args.a2)
			a3.toEqual(args.a3)
	...
	fun dropArg5() {
		...
		val argsResult: Args4<String, Int, Long, Float> = args.dropArg5()
		expect(argsResult) {
			a1.toEqual(args.a1)
			a2.toEqual(args.a2)
			a3.toEqual(args.a3)
