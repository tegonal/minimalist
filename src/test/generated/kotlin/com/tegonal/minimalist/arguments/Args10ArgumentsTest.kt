...
class Args10ArgumentsTest {
	...
	companion object {
		@JvmStatic
		fun args() : List<Args10<String, Int, Long, Float, Double, Char, LocalDate, Short, Byte, BigInteger>> =
			listOf(Args.of("string", 1, 2L, 3F, 4.0, 'c', LocalDate.now(), 1.toShort(), 2.toByte(), 3.toBigInteger()))
	}
}